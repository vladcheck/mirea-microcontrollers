/*====================================================================
 * ПР №3-4, учебный пример (листинги 9.3 и 9.4 методички, Proteus) —
 * запись и чтение EEPROM 24LC64 и настройка DS1307 через I2C1
 * STM32F103C8 (HSI 8 МГц, fSCL = 100 кГц: FREQ=8, CCR=40, TRISE=9).
 *
 * Значения по умолчанию из методички:
 *   EEPROM_CELL = 0x0010, EEPROM_TEST_VALUE = 0x34, DS1307_TEST_REG = 0x00.
...
/* Значения заменяются по индивидуальному варианту. */
#define EEPROM_CELL       0x0010U
#define EEPROM_TEST_VALUE 0x34U
